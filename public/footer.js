...
(function () {
  var CSS = [
    ...
    '.gfs-footer-wordmark{font-size:12px;font-weight:900;text-transform:uppercase;letter-spacing:.12em;color:rgba(255,255,255,.35);text-decoration:none;transition:color .15s;}',
    ...
    '.gfs-footer-link{font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:.16em;color:rgba(255,255,255,.25);text-decoration:none;transition:color .15s;}',
    ...
    '.gfs-footer-copy{font-size:9px;font-weight:400;color:rgba(255,255,255,.18);letter-spacing:.06em;}',
