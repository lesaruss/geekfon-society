...
.pulse-timestamp{font-size:10px;color:var(--lr-text-50)}
.pulse-badges{display:flex;align-items:center;gap:4px;flex-shrink:0}
.pulse-type{display:inline-block;background:#e8f0fe;color:#1967d2;padding:2px 8px;border-radius:8px;font-size:9px;font-weight:600;text-transform:uppercase;white-space:nowrap}
...
.pulse-engagement{display:flex;gap:8px;padding:8px 12px;border-top:1px solid #ddd;font-size:11px;color:var(--lr-text-75);flex-wrap:wrap}
.pulse-stat{display:flex;align-items:center;gap:3px}
.pulse-stat span:first-child{font-size:12px}
.pulse-pagination{display:flex;align-items:center;justify-content:center;gap:12px;margin-top:32px;padding:16px 0}
.pulse-page-btn{padding:8px 16px;background:var(--rx);color:#fff;border:none;border-radius:8px;cursor:pointer;font-weight:600;font-size:12px}
.pulse-page-btn:disabled{opacity:.5;cursor:not-allowed}
