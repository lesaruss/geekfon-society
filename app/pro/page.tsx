...
// Renamed from GeekFon Plus to GeekFon Pro, 2026-07-27 per Sean: same invite-only
// ambassador program (application + waitlist, small number accepted per region),
// updated value proposition - full catalog access in exchange for growing
// membership, affiliate commission off a personal referral URL, early access to
// unreleased content for feedback, more perks rolling out over time. Old /plus
// URL redirects here permanently (see next.config.ts).
export default function ProApplyPage() {
  ...
  async function uploadVideo(file: File): Promise<string> {
    ...
    const res = await fetch("/api/pro-apply/upload-url", {
      method: "POST",
      ...
      <div className="plus-page">
        ...
        <div className="plus-hero">
          ...
          <div className="plus-hero-content">
            <div className="plus-hero-badge">Invite Only - Apply to Join the Waitlist</div>
            <h1 className="plus-hero-title">GeekFon Pro</h1>
            <p className="plus-hero-sub">
              A select group of members who help carry GeekFon Society into the real world.
              This is not a signup. It is an invitation we extend, after you apply and we choose you.
            </p>
          </div>
        </div>
        ...
        <div className="plus-layout">
          ...
          <div className="plus-main">
            ...
            <section className="plus-section">
              <h2 className="plus-section-title">What is Pro?</h2>
              <p className="plus-section-text">
                GeekFon Pro members get full access to the entire catalog, every artist, every
                song, released or not, in exchange for bringing new members into GeekFon Society.
                Every person you bring in is tracked to your own personal link, and you earn a
                commission on it. You also get early access to new content before anyone else, so
                you can give us feedback before it goes public. More perks roll out to Pro members
                over time.
                <br /><br />
                This is invite-only. You apply, you go on the waitlist, and we accept a small
                number of people in each region so the people representing GeekFon are the right
                ones. We watch every application personally.
              </p>
            </section>
            ...
            <section className="plus-section">
              ...
              <div className="plus-perks">
                {[
                  { icon: "M20 7H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2zM12 14a2 2 0 1 1 0-4 2 2 0 0 1 0 4z", label: "Full catalog access", desc: "Every artist, every song, released or not - the entire GeekFon Society library" },
                  { icon: "M2.5 18.5l7-7 4 4L20.5 8M22 12v6a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h6", label: "Affiliate commission", desc: "Earn commission on every member who joins through your personal link" },
                  { icon: "M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z", label: "Early access", desc: "Hear new content before anyone else and give us feedback that shapes it" },
                  { icon: "M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z", label: "Verified Pro status", desc: "Official Pro badge, credentials, and team brief" },
                  { icon: "M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2M9 3a4 4 0 1 1 0 8 4 4 0 0 1 0-8zM23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75", label: "Your city, your chapter", desc: "Represent the community in your region, online and on the ground" },
                  { icon: "M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01", label: "More to come", desc: "New Pro perks roll out over time as the program grows" },
                ].map((perk, i) => (
            ...
            <section className="plus-section plus-form-section">
              {status === "success" ? (
                ...
                <>
                  <h2 className="plus-section-title">Apply to the waitlist</h2>
                  ...
                  <form className="plus-form" onSubmit={handleSubmit} noValidate>
                    ...
                    <div className="plus-field">
                      ...
                      <textarea id="plus-reason" className="plus-input plus-textarea"
                        placeholder="Tell us how you move in your city, what you bring, and why GeekFon Pro should be yours."
            ...
            <p className="plus-fine-print">
              ...
              Selected members will be contacted directly. We read every application.
            </p>
          </div>
            ...
            <div className="plus-sidebar-block">
              ...
              <div className="plus-steps">
                {[
                  ...
                  { n: "02", t: "Waitlist", d: "You're in the queue for your region." },
                  { n: "03", t: "Review", d: "The team watches every video personally." },
                  { n: "04", t: "Invite", d: "If chosen, get your link, badge, and city brief." },
                ].map((s, i) => (
