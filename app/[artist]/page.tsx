...
const ARTIST_CITY: Record<string, { desktop: string; mobile: string; position?: string }> = {
  ...
  "likkle-sis":          { desktop: CDN + "hf_20260619_060647_f5cc249a-0fe0-4f02-97a4-2a848334cf98.png", mobile: CDN + "hf_20260619_062128_cd958296-6f06-4efb-ad10-97306f3d2558.png" },
  "likkle-bro":          { desktop: CDN + "hf_20260619_060647_f5cc249a-0fe0-4f02-97a4-2a848334cf98.png", mobile: CDN + "hf_20260619_062128_cd958296-6f06-4efb-ad10-97306f3d2558.png" },
  ...
  // 2026-07-31 per Sean: this specific source image has ~80px of solid black
  // canvas baked into its bottom edge (and a smaller black margin at the
  // top) - the default "center bottom" crop anchor guarantees that bottom
  // black band is always visible on wide viewports. "center 55%" shifts the
  // crop window up: cuts off the black bottom margin, shows less of the
  // lake/fountain water and more of the skyline behind it.
  "nilo-wave":           { desktop: CDN + "hf_20260619_125302_4c4f6747-3bcb-45b2-a743-610912078942.png", mobile: CDN + "hf_20260619_125452_ad933e6f-0b03-43a4-b111-341e76b9efd9.jpeg", position: "center 55%" },
