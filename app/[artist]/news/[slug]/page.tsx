...
const ARTIST_CITY: Record<string, { desktop: string; mobile: string; position?: string }> = {
  ...
  // 2026-07-31 per Sean: matches the same fix in app/[artist]/page.tsx -
  // this source image has ~80px of solid black baked into its bottom edge,
  // "center 55%" avoids ever showing it and favors skyline over water.
