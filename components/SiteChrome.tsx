      ...
      <header className="gtop">
        ...
        {member ? (
          <div className="gmember-chip">
            ...
            <div className="gmember-avatar" aria-label={member.name}>
              {member.initial}
            </div>
          </div>
        ) : (
...
.gcta {
  ...
  color: var(--rx-text, #9c1458); border: 1px solid var(--rx, #E91E8C);
...
.gmember-balance-label { font-size: 8px; font-weight: 800; text-transform: uppercase; letter-spacing: .14em; color: var(--rx-text, #9c1458); margin-top: 2px; }
.gmember-avatar {
...
.gnav-section {
  font-size: 9px; font-weight: 800; text-transform: uppercase; letter-spacing: .2em;
  color: rgba(255,255,255,.25); padding: 12px 14px 6px; margin-top: 4px;
...
.gdm-avatar { width: 38px; height: 38px; border-radius: 50%; background: var(--rx, #E91E8C); color: #fff; font-size: 15px; font-weight: 900; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
